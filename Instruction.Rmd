...
```yaml
---
title: "Source Code for the Political Terror Dashboard"
author: "Mohsen Monji"
output:
  pdf_document: default
  html_document: default
...
This document provides details on the source code for the Political Terror Dashboard. The purpose of this document is to outline how to access and understand the code. For those interested in exploring the code or making contributions, follow the steps below.
